...
---
คำตอบแบบทดสอบทบทวน ส่วนที่ 5: แผนปฏิบัติการป้องกันอุบัติเหตุหน้างาน (Practical Safety Action Plan)
1. การกำหนดมาตรการตัดโดมิโนตัวที่ 3 (Domino Interrupt Action)
การกำจัด Unsafe Act ทำได้โดยห้ามพนักงานเทเติมแอลกอฮอล์เหลวลงในเตาที่มีไฟติดอยู่โดยเด็ดขาด ให้ยึดหลักเปลี่ยนยกเตาเก่าออกไปดับไฟด้านหลังร้าน แล้วนำเตาใหม่ที่เตรียมไว้มาวางแทนเท่านั้น ส่วนการกำจัด Unsafe Condition ทำได้โดยยกเลิกการใช้ขวดแอลกอฮอล์เหลวเปิดฝา เปลี่ยนไปใช้แอลกอฮอล์ก้อนจุดไฟ หรือใช้ภาชนะบรรจุสารไวไฟนิรภัย (Safety Can) ที่มีลิ้นวาล์วป้องกันไฟย้อน พร้อมติดป้ายเตือนอันตรายจากสารไวไฟชัดเจนบริเวณจุดเตรียมเตา
2. การออกแบบแนวป้องกัน 4 ชั้นตาม Swiss Cheese Model (Defense-in-Depth Design)
 * 🧀 ด่านที่ 1 (นโยบาย/กฎระเบียบ): กำหนดนโยบาย "Zero Tolerance ต่อการเติมสารไวไฟขณะมีเปลวไฟ" และออกกฎบังคับใช้มาตรฐานความปลอดภัยในการจัดการสารไวไฟอย่างเคร่งครัด
 * 🧀 ด่านที่ 2 (ระบบวิศวกรรม/การตัดไฟ/การ์ดกั้น): เปลี่ยนไปใช้ถังบรรจุแอลกอฮอล์นิรภัย (Safety Can) ที่มีระบบป้องกันไฟย้อน (Flame Arrester) หรือเปลี่ยนไปใช้เตาหมูกระทะแบบระบบแก๊สกระป๋อง/ไฟฟ้าที่มีระบบตัดไฟอัตโนมัติ
 * 🧀 ด่านที่ 3 (ขั้นตอน SOP/ป้ายเตือน/การอบรม): จัดทำขั้นตอนการปฏิบัติงานมาตรฐาน (SOP) ในการเปลี่ยนเตาไฟ อบรมพนักงานใหม่ทุกคนก่อนเริ่มงาน และติดป้ายเตือนอันตรายบริเวณพื้นที่เตรียมเตา
 * 🧀 ด่านที่ 4 (อุปกรณ์ป้องกันส่วนบุคคล PPE): บังคับให้พนักงานฝ่ายเตรียมเตาและฝ่ายบริการทุกคนสวมใส่ถุงมือกันความร้อน และกระบังหน้าป้องกันความร้อน (Face Shield) หรือแว่นตานิรภัยขณะปฏิบัติงาน
3. การส่งเสริม Near Miss & บทพูดสร้างแรงจูงใจลูกน้อง (Safety Leadership & Motivation Speech)
 * มาตรการ Near Miss:
   ใช้นโยบาย "No-Blame Culture" ไม่ลงโทษพนักงานที่แจ้งเหตุการณ์เกือบเกิดอุบัติเหตุ พร้อมจัดทำระบบ "Safety Point" ให้พนักงานสะสมคะแนนจากการแจ้งจุดเสี่ยงหรือเหตุการณ์ Near Miss เพื่อนำมาแลกรางวัลพิเศษประจำเดือน เพื่อเปลี่ยนการรายงานความเสี่ยงให้เป็นเรื่องบวกและสร้างการมีส่วนร่วม
 * 🗣️ บทพูดสร้างแรงจูงใจก่อนเริ่มงาน (Safety Motivation Speech):
   > "อรุณสวัสดิ์ทุกคนครับ! จำไว้นะครับว่าไม่มีงานไหนสำคัญไปกว่าความปลอดภัยและชีวิตของพวกเรา ใส่อุปกรณ์ PPE ตรวจเช็กเตาและแอลกอฮอล์ให้ปลอดภัยก่อนส่งถึงมือลูกค้าทุกครั้ง ทำตามขั้นตอน SOP ไม่เร่งรีบจนประมาท เพราะคนที่บ้านกำลังรอเรากลับไปทานข้าวพร้อมหน้ากันอย่างปลอดภัยเย็นนี้นะครับ!"
   > 
